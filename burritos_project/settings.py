...
# ... (cerca de la línea 30)

ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'tu-nombre-en-pythonanywhere.com']
...
import os
from pathlib import Path  # Asegúrate de que esto esté al inicio del archivo

# ... (resto de tu código) ...

# CONFIGURACIÓN DE BASE DE DATOS INTELIGENTE
# Si el directorio actual contiene 'pythonanywhere', usa MySQL. Si no, usa SQLite.
if 'pythonanywhere' in os.getcwd():
    ...
    # Configuración Local (Debe estar indentada bajo el 'else:')
    DATABASES = {
        'default': {
...
# Asegúrate de que NO haya otra definición de DATABASES debajo de esto.
